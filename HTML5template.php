...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  <a href="Education.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">TRAINING</a>
  <a href="WorkExperience.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">TUTORIAL</a>
  <a href="Hobbies.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">COURSES</a>
</div>
